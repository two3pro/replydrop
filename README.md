...
当前 Chrome / Brave 公开包已同步 Safari `0.2.249` 的 traffic-first 评分与共享 runtime 基线，版本号提升为 `0.2.250`。
...
- Chrome / Brave 运行时包：[replydrop-p2.250.zip](./downloads/replydrop-p2.250.zip)
...
- 版本说明：
  - Chrome / Brave 当前公开基线版本已同步到 `0.2.250`
...
当前会生成 `replydrop-p2.250.zip` 这样的安装包。
