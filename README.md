...
当前 Chrome / Brave 公开包继续沿用 Safari `0.2.249` 的共享 runtime 基线；`0.2.250 / 0.2.251` 已把首页 timing/traffic 调优收紧到 traffic-first 正轨，`0.2.252` 把 reply ledger / pickup performance 跟踪链补完整，`0.2.253` 把 homepage traffic gating 拉回人工实盘节奏，而 `0.2.254` 继续把“主帖热度”和“回复位吃流量能力”拆开，修掉热主帖弱回复位被打高分的问题。
...
- Chrome / Brave 运行时包：[replydrop-p2.254.zip](./downloads/replydrop-p2.254.zip)
...
- 版本说明：
  - Chrome / Brave 当前公开基线版本已同步到 `0.2.254`
